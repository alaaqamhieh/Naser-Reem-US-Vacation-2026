...
export const SEED_ACTIVITIES: ActivityIdea[] = [
  ...
  {
    id: 'world-cup-qf1',
    title: 'World Cup Quarterfinal: Spain v Belgium',
    emoji: '⚽',
    category: 'home',
    description: 'FIFA World Cup 2026 quarterfinal, Los Angeles — check the exact kickoff time closer to the date.',
  },
  {
    id: 'world-cup-qf2',
    title: 'World Cup Quarterfinal: Norway v England',
    emoji: '⚽',
    category: 'home',
    description: 'FIFA World Cup 2026 quarterfinal, Miami — check the exact kickoff time closer to the date.',
  },
  {
    id: 'world-cup-qf3',
    title: 'World Cup Quarterfinal: Argentina v Switzerland',
    emoji: '⚽',
    category: 'home',
    description: 'FIFA World Cup 2026 quarterfinal, Kansas City — check the exact kickoff time closer to the date.',
  },
  {
    id: 'world-cup-sf1',
    title: 'World Cup Semifinal: France v Winner (Spain/Belgium)',
    emoji: '⚽',
    category: 'home',
    description: 'FIFA World Cup 2026 semifinal, Arlington, TX — check the exact kickoff time closer to the date.',
  },
  {
    id: 'world-cup-sf2',
    title: 'World Cup Semifinal: Winner (Norway/England) v Winner (Argentina/Switzerland)',
    emoji: '⚽',
    category: 'home',
    description: 'FIFA World Cup 2026 semifinal, Atlanta — check the exact kickoff time closer to the date.',
  },
  {
    id: 'bbq-night',
